...
class PhoneCapability_siemens extends PhoneCapability
{
	...
	function conv_ringtone( $infile, $outbase )
	{
		...
		*/
		...
		gs_log( GS_LOG_NOTICE, 'Ringtone conversion for Siemens phones is implemented for MP3 files of less than 1 MB only' );
		...
		$cmd = 'sox '. qsa($infile) .' -r 8000 -c 1 -w '. qsa($outfile) .' trim 0 125000s';
